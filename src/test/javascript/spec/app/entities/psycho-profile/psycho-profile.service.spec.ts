...
describe('Service Tests', () => {
  describe('PsychoProfile Service', () => {
    let injector: TestBed;
    let service: PsychoProfileService;
    let httpMock: HttpTestingController;
    let elemDefault: IPsychoProfile;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a PsychoProfile', () => {
      ...
      it('should update a PsychoProfile', () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of PsychoProfile', () => {
        const returnedFromService = Object.assign(
          {
            summaryProfile: 'BBBBBB',
            jungValues: 1
      ...
      it('should delete a PsychoProfile', () => {
